...
pkgdatadir = $(datadir)/apertium-ain
pkgincludedir = $(includedir)/apertium-ain
pkglibdir = $(libdir)/apertium-ain
pkglibexecdir = $(libexecdir)/apertium-ain
...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/apertium-ain.pc.in COPYING install-sh missing
...
CONFIG_CLEAN_FILES = apertium-ain.pc
...
am__installdirs = "$(DESTDIR)$(apertium_aindir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_ain_DATA) $(noinst_DATA) $(pkgconfig_DATA)
...
ACLOCAL = ${SHELL} /home/swatstudent/Source/ling073-ain/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AUTOCONF = ${SHELL} /home/swatstudent/Source/ling073-ain/missing autoconf
AUTOHEADER = ${SHELL} /home/swatstudent/Source/ling073-ain/missing autoheader
AUTOMAKE = ${SHELL} /home/swatstudent/Source/ling073-ain/missing automake-1.14
AWK = gawk
CGCOMP = /usr/bin/cg-comp
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Ainu\" -DPACKAGE_TARNAME=\"apertium-ain\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ Ainu\ 0.1.0\" -DPACKAGE_BUGREPORT=\"dwurtel1@swarthmore.edu\" -DPACKAGE_URL=\"http://wiki.apertium.org/wiki/Apertium-ain\" -DPACKAGE=\"apertium-ain\" -DVERSION=\"0.1.0\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/swatstudent/Source/ling073-ain/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-ain
PACKAGE_BUGREPORT = dwurtel1@swarthmore.edu
PACKAGE_NAME = Apertium Ainu
PACKAGE_STRING = Apertium Ainu 0.1.0
PACKAGE_TARNAME = apertium-ain
PACKAGE_URL = http://wiki.apertium.org/wiki/Apertium-ain
...
STRIP = 
VERSION = 0.1.0
abs_builddir = /home/swatstudent/Source/ling073-ain
abs_srcdir = /home/swatstudent/Source/ling073-ain
abs_top_builddir = /home/swatstudent/Source/ling073-ain
abs_top_srcdir = /home/swatstudent/Source/ling073-ain
am__leading_dot = .
...
install_sh = ${SHELL} /home/swatstudent/Source/ling073-ain/install-sh
...
###############################################################################
#
#   apertium_ain_dir: This is where the compiled binaries go
#   apertium_ain_srcdir: This is where the source files go
apertium_aindir = $(prefix)/share/apertium/$(BASENAME)/
apertium_ain_srcdir = $(prefix)/share/apertium/$(BASENAME)/
EXTRA_TARGETS = $(am__append_1)
apertium_ain_DATA = $(TARGETS_COMMON) $(EXTRA_TARGETS) $(LANG1).prob
...
$(am__aclocal_m4_deps):
apertium-ain.pc: $(top_builddir)/config.status $(srcdir)/apertium-ain.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_ainDATA: $(apertium_ain_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_ain_DATA)'; test -n "$(apertium_aindir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_aindir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_aindir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_aindir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_aindir)" || exit $$?; \
	done

uninstall-apertium_ainDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_ain_DATA)'; test -n "$(apertium_aindir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_aindir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_aindir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_ainDATA install-data-local \
...
uninstall-am: uninstall-apertium_ainDATA uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_ainDATA install-data \
	...
	uninstall-am uninstall-apertium_ainDATA \
	uninstall-pkgconfigDATA
...
install-data-local: install-modes
	test -d $(DESTDIR)$(apertium_ain_srcdir) || mkdir -p $(DESTDIR)$(apertium_ain_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).lexc $(DESTDIR)$(apertium_ain_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).twol $(DESTDIR)$(apertium_ain_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).rlx $(DESTDIR)$(apertium_ain_srcdir)
	$(INSTALL_DATA) $(BASENAME).post-$(LANG1).dix $(DESTDIR)$(apertium_ain_srcdir)
clean-local:
	-rm -rf .deps modes
...
test: all
	echo "TODO test sentence" | apertium -d . ain-morph | tee .test-mt
